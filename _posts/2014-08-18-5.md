...
What if we wanted to match an end tag (i.e. `</tag>`)? Well, add a single thing, and you've got yourself something regular (pun intended, now laugh).
